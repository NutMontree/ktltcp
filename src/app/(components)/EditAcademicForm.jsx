...
//   const EDITMODE = academic && academic._id !== "new";
...
//     <>
//       <DefaultLayout>
//         <Breadcrumb pageName="New Academic" />
...
//                 <div className="2xl:px-20">ระบบ ตรวจเช็ค Academic งานแผน</div>
...
const EditAcademicForm = ({ academic }) => {
  ...
  if (EDITMODE) {
    startingAcademicData["year"] = academic.year || startingAcademicData.year;
    startingAcademicData["department"] =
      academic.department || startingAcademicData.department;
    startingAcademicData["namework"] = academic.namework || "";
    startingAcademicData["nameproject"] = academic.nameproject || "";
    startingAcademicData["fileUrl"] = academic.fileUrl || null;
    startingAcademicData["originalFileName"] =
      academic.originalFileName || null;
    startingAcademicData["id1"] = academic.id1 || "";
    startingAcademicData["id2"] = academic.id2 || "";
    startingAcademicData["id3"] = academic.id3 || "";
    startingAcademicData["id4"] = academic.id4 || "";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      } else if (EDITMODE && academic.fileUrl && !formData.fileUrl) {
      ...
      if (EDITMODE) {
        res = await fetch(`/api/Academics/${academic._id}`, {
          method: "PUT",
          body: formToSend,
        });
      } else {
  ...
  return (
    <>
      <DefaultLayout>
        <Breadcrumb pageName={EDITMODE ? "Update Academic" : "New Academic"} />
